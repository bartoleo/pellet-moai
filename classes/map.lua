...
self.curvecoins:setKey ( 2, 0.15, 130, MOAIEaseType.FLAT )
self.curvecoins:setKey ( 3, 0.30, 131, MOAIEaseType.FLAT )
self.curvecoins:setKey ( 4, 0.45, 132, MOAIEaseType.FLAT )
self.curvecoins:setKey ( 5, 0.60, 131, MOAIEaseType.FLAT )
self.curvecoins:setKey ( 6, 0.75, 130, MOAIEaseType.FLAT )
self.curvecoins:setKey ( 7, 0.90, 129, MOAIEaseType.FLAT )
